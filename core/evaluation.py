...
3. Structre the feedback in multiple lines.
4. A score from 0 to 10 (integer only), based on correctness of users translation compared to english sentence.
5. While scoring, ignore any minor punctuation or accent errors, focus on the overall meaning and structure.
